...
export class FileUploadComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    this.uploadUrl = 'https://evening-anchorage-315.herokuapp.com/api/';
  ...
  ngOnInit() {
    ...
    this.uploader.onBuildItemForm = (fileItem: FileItem, form: FormData) => {
      ...
      console.log("Yuhee");
      form.append('someField', 'testValue0'); //note comma separating key and value
      form.append('someField2', 'testValue1');
    };
